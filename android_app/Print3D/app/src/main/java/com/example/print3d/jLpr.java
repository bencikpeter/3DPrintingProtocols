...
/**
 * <P><B>jLpr</B> provides an interface to LPD print servers running on network hosts
 * and network connected printers.</P><P>It conforms to RFC 1179.</P>
 */
 
public class jLpr {

    private static final String TAG = "jLPR lib";
	...
	public void printFile(String fileName, String hostName, String printerName, String documentName)
		...
		Log.d(TAG, "before socket request");
		Socket socketLpr = getSocket(hostName);
        Log.d(TAG, "after socket request");
